...
Public visual-identity assets for **hardcopy-console** (PC-DOS master face + room shorts).

Parent: [../](../) (docs media). Constitution (local): `../../.local/visual-identity/CONSTITUTION.md`.
...
| [short-386bsd-slate.png](short-386bsd-slate.png) | Secondary social short — 386BSD slate austere |

Do not replace the default hero with a multi-OS logo collage.
