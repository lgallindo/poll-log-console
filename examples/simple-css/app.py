"""
Simple.css demo site + hardcopy-console.
Run: PYTHONPATH=../../src/python python3 app.py  →  http://127.0.0.1:8774/
"""
...
<head>
  ...
  <title>hardcopy-console on Simple.css</title>
...
<body>
  ...
  <main id="main">
    <article>
      ...
      <p>
        This sample shows <strong>hardcopy-console</strong> sitting on a
  ...
  <footer>
    <p>hardcopy-console · Simple.css demo · GPL-3.0-or-later</p>
  </footer>
